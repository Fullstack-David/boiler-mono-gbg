...
dotenv.config();
const clientID = process.env.GITHUB_CLIENT_ID as string  // test med hårdkodad env för docker ska fungera
const clientSecret = process.env.GITHUB_CLIENT_SECRET as string  // test med hårdkodad env för docker ska fungera
